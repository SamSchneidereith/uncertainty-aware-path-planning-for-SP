function [x,Pout] = SPSteerV4(Start,Goal,delta,W,Tol,P,Q,RVal)
...
% EKF Noises:
% Observation Noise:
R = RVal*[0.308764757748884	-0.00222047549336229	-0.00474512475051407	-5.92116799337972e-06	0.000190262896200763	-2.45290047621554e-05;
...
%for k = 2:N
    ...
    check2 = PosCheck(xtrue(:,k));
    % EKF Prediction Step:H'/S
